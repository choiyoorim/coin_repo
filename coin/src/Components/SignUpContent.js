    ...
    return (
      <div className="content">
        <form id="content-signup" onSubmit = {onSubmitHandler}>
          ...
          <br />
          <label>비밀번호</label>
          <input class="input_pwd" required type="password" placeholder="password" onChange={onPasswordHandler}/>
          
          <br />
          <label>비밀번호 재확인</label>
          <input class="input_repwd" required type="password" placeholder="confirmPassword" onChange={onConfirmPasswordHandler}/>
